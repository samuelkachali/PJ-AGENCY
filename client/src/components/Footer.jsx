            ...
            <ul className="footer__contact">
              <li>
                <a href="tel:+265999000000">
                  ...
                  <span className="footer__contact-text">+265 999 000 000</span>
                </a>
              </li>
              <li>
                <a href="mailto:info@pjagency.mw">
                  <span className="footer__contact-icon">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <span className="footer__contact-text">info@pjagency.mw</span>
                </a>
              </li>
              <li>
                <a href="https://maps.google.com" target="_blank" rel="noopener noreferrer">
                  ...
                  <span className="footer__contact-text">123 Business District, Blantyre, Malawi</span>
                </a>
              </li>
            </ul>
          </div>
